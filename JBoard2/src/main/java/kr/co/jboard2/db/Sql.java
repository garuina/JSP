...
public class Sql {
	...
	public static final String SELECT_USER_FOR_SESSID  = "select * from `board_user` where `sessId`=? and `pass`=SHA2(?, 256)";
	...
	public static final String UPDATE_USER_GRADE = "UPDATE `board_user` SET `grade`= 0, `wdate`= NOW() WHERE `uid` = ?";
