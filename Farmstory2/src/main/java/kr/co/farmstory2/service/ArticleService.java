...
public enum ArticleService {
		...
		public int selectCountTotalForSearch(String cate,String keyword) {
			return dao.selectCountTotalForSearch(cate,keyword);
		}
		...
		public List<ArticleVO> selectArticleByKeyword(String cate,String keyword, int start) {
			return dao.selectArticleByKeyword(cate,keyword, start);
		}
